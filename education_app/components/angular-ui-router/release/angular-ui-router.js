 ...
 * * `'/usermanager/:id'` - Matches '/usermanager/bob' or '/usermanager/1234!!!' or even '/usermanager/' but not '/usermanager' or
 *   '/usermanager/bob/details'. The second path segment will be captured as the parameter 'id'.
 * * `'/usermanager/{id}'` - Same as the previous example, but using curly brace syntax.
 * * `'/usermanager/{id:[^/]*}'` - Same as the previous example.
 * * `'/usermanager/{id:[0-9a-fA-F]{1,8}}'` - Similar to the previous example, but only matches if the id
 ...
 * <pre>
 * new UrlMatcher('/usermanager/{id}?q').concat('/details?date');
 * new UrlMatcher('/usermanager/{id}/details?q&date');
 * </pre>
 *
 ...
 * @example
 * <pre>
 * new UrlMatcher('/usermanager/{id}?q&r').exec('/usermanager/bob', {
 *   x: '1', q: 'hello'
 * });
 ...
 * @example
 * <pre>
 * new UrlMatcher('/usermanager/{id}?q').format({ id:'bob', q:'yes' });
 * // returns '/usermanager/bob?q=yes'
 * </pre>
 *
...
//  function regexpMatches(val) { /*jshint validthis:true */ return isDefined(val) && this.pattern.test(val); }
   ...
   *   // ...
   * }).state('users.item', {
   *   url: "/{usermanager:dbObject}",
   *   controllers: function($scope, $stateParams) {
   *     // $stateParams.usermanager will now be an object returned from
   *     // the Users service
   *   },
   *   // ...
   * });
...
function $UrlRouterProvider(   $locationProvider,   $urlMatcherFactory) {
   ...
   *   // otherwise will take care of routing the usermanager to the
   *   // specified url
   ...
   * @param {string|object} handler The path you want to redirect your usermanager to.
   */
   ...
   *     // UserService is an example service for managing usermanager state
   ...
   *       // Once the usermanager has logged in, sync the current URL
   *       // to the router:
   *       $urlRouter.sync();
   *     });
   *   });
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter,   $location,   $urlMatcherFactory) {
    ...
    // Handles the case where a state which is the target of a transition is not found, and the usermanager
 ...
 *     <a href ui-sref="app.usermanager({usermanager: 'bilbobaggins'})">@bilbobaggins</a>
 *   </li>
 * </ul>
 * </pre>
 *
 *
 * When the app state is "app.usermanager" (or any children states), and contains the state parameter "usermanager" with value "bilbobaggins",
 * the resulting HTML will appear as (note the 'active' class):
 * <pre>
 * <ul>
 *   <li ui-sref-active="active" class="item active">
 *     <a ui-sref="app.usermanager({usermanager: 'bilbobaggins'})" href="/users/bilbobaggins">@bilbobaggins</a>
 *   </li>
 * </ul>
 * </pre>
 *
 ...
 *     <a ui-sref="app.usermanager">link</a>
 *   </li>
 * </ul>
 * </pre>
 */
